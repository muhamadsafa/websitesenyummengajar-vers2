...
<body>
 ...
 <div class="container-fluid bg-primary pt-3 d-none d-lg-block">
          ...
          <img class="logo" src="Asset/img/logoisb.png" alt="logo" style="height: 80px" />
                    ...
                    <div class="collapse navbar-collapse " id="navbarNav">
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active mx-3" href="admnperpus.php">Ruang Baca Admin</a>
                            </li>
                            <li class="nav-item">
    ...
    <!-- Navbar -->
      ...
      <div class="container">
        <h3>Data Admin Reservasi Ruang Baca</h3>
        ...
        if (mysqli_num_rows($ruangbc) > 0) {
            echo '<table class="table">
                <tr>
                    <th>ID</th>
                    <th>Nama Reservasi</th>
                    <th>Nama Ruangan</th>
                    <th>Tanggal Reservasi & Pukul Reservasi</th>
                    <th>Aksi</th>
                </tr>';

            while ($row = mysqli_fetch_assoc($ruangbc)) {
                echo '<tr>
                   <td>' . $row['id'] . '</td>
                    <td>' . $row['namareservasi'] . '</td>
                    <td>' . $row['ruangbaca'] . '</td>
                    <td>' . $row['tanggaljamruang'] . '</td>
                    <td>
                        <a href="editadmruangbaca.php?id=' . $row['id'] . '">Edit</a>
                        <a href="deleteadmruangbaca.php?id=' . $row['id'] . '">Hapus</a>
                    </td>
                </tr>';
            }
            ...
            echo '<p>Tidak ada Data Tambahan Reservasi Ruang Baca.</p>';
        }
        ...
        <a href="addadmruangbaca.php" class="btn btn-primary">Tambah Data Reservasi Ruang Baca</a>
    </div>
