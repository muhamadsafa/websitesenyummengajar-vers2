          ...
          <img class="logo" src="Asset/img/logoisb.png" alt="logo" style="height: 80px" />
                    ...
                    <div class="collapse navbar-collapse " id="navbarNav">
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active mx-3" href="admninventaris.php">Inventaris Admin</a>
                            </li>
                            <li class="nav-item">
    ...
    <!-- Navbar -->
      ...
      <div class="container">
        ...
        if (mysqli_num_rows($inventaris) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($inventaris)) {
                echo '<tr>
                   <td>' . $row['id'] . '</td>
                    ...
                    <td>' . $row['tanggal'] . '</td>
                    <td>
                        <a href="editadminventaris.php?id=' . $row['id'] . '">Edit</a>
                        <a href="deleteadminventaris.php?id=' . $row['id'] . '">Hapus</a>
                    </td>
                </tr>';
            }
            ...
            echo '<p>Tidak ada Data Tambahan Inventaris.</p>';
        }
        ...
        <a href="addadminventaris.php" class="btn btn-primary">Tambah Data Inventaris</a>
    </div>
