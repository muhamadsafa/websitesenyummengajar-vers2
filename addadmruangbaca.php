...
<body>
 ...
 <div class="container-fluid bg-primary pt-3 d-none d-lg-block">
    ...
    <!-- Navbar -->
      ...
      <div class="container">
        <h2>Tambah Reservasi Ruangan</h2>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "INSERT INTO ruangbc (namareservasi, ruangbaca, tanggaljamruang) VALUES ('$namareservasi', '$ruangbaca', '$tanggaljamruang')";
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            <div class="form-group">
                <label for="nama">Nama Reservasi:</label>
                <input type="text" class="form-control" name="namareservasi" required>
            </div>
            <div class="form-group">
                <label for="email">Ruang Baca:</label>
                <input type="text" class="form-control" name="ruangbaca" required>
            </div>
            <div class="form-group">
                <label for="telepon">Tanggal & Jam:</label>
                <input type="text" class="form-control" name="tanggaljamruang" required>
            </div>
