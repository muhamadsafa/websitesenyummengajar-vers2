 ...
 <div class="container-fluid bg-primary pt-3 d-none d-lg-block">
    ...
    <div class="container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            $namareservasi = $_POST["namareservasi"];
            $ruangbaca = $_POST["ruangbaca"];
            $tanggaljamruang = $_POST["tanggaljamruang"];

            $sql = "UPDATE ruangbc SET namareservasi='$namareservasi', ruangbaca='$ruangbaca', tanggaljamruang='$tangaljamruang' WHERE id=$id";
        ...
        $sql = "SELECT * FROM ruangbc WHERE id=$id";
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . '?id=' . $id; ?>">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="namareservasi" value="<?php echo $row['namareservasi']; ?>" required>
            </div>
            <div class="form-group">
                <label for="ruangbaca">Ruang Baca:</label>
                <input type="text" class="form-control" name="ruangbaca" value="<?php echo $row['ruangbaca']; ?>" required>
            </div>
            <div class="form-group">
                <label for="tanggaljamruang">tanggal & Jam:</label>
                <input type="text" class="form-control" name="tanggaljamruang" value="<?php echo $row['tanggaljamruang']; ?>" required>
            </div>
            <button type="submit" class="btn btn-primary">Simpan</button>
            <a href="admnperpus.php" class="btn btn-secondary">Batal</a>
        </form>
    </div>
