...
<body>
 ...
 <div class="container-fluid bg-primary pt-3 d-none d-lg-block">
    ...
    <div>
    <form method="post" action="login.php" class="container-fluid p-5 my-2 bg-white text-center text-primary">
        <div class="input-group form-login mb-1 mt-5">
            <label class="form-label"></label>
            <input type="text" required class="form-control" placeholder="Username" name="usernameadmin">
        </div>
        <div class="input-group form-login mb-4">
            <label class="form-label"></label>
            <input type="password" required class="form-control" placeholder="Password" name="passwordadmin">
        </div>
        <div class="input-group">
            <button type="submit" class="btn btn-primary py-md-3 px-md-5 mt-2" name="login_admin">Login</button>
        </div>
    </form>
</div>
</div>
