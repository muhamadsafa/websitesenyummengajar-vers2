...
<body>
 ...
 <div class="container-fluid bg-primary pt-3 d-none d-lg-block">
    ...
    <div class="container">
        <h2>Edit Data Pemesan Merchandise</h2>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "UPDATE merchandise SET namapemesan='$namapemesan', namamerchan='$namamerchan', jumlahhargamerchan='$jumlahhargamerchan' WHERE id=$id";
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . '?id=' . $id; ?>">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="namapemesan" value="<?php echo $row['namapemesan']; ?>" required>
            </div>
            <div class="form-group">
                <label for="namamerchandise">Nama Merchandise:</label>
                <input type="text" class="form-control" name="ruangbaca" value="<?php echo $row['namamerchan']; ?>" required>
            </div>
            <div class="form-group">
                <label for="jumlah-hargamerchandise">Jumlah & Total Harga Merchandise:</label>
                <input type="text" class="form-control" name="jumlahhargamerchan" value="<?php echo $row['jumlahhargamerchan']; ?>" required>
            </div>
