    ...
    <div class="container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
           $jenis = $_POST["jenis"];
            ...
            $sql = "UPDATE inventaris SET jenis='$jenis', jumlah='$jumlah', tanggal='$tanggal' WHERE id=$id";
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . '?id=' . $id; ?>">
            <div class="form-group">
                <label for="jenis">Jenis Inventaris:</label>
                <input type="text" class="form-control" name="jenis" value="<?php echo $row['jenis']; ?>" required>
            </div>
            <div class="form-group">
            ...
            <a href="admninventaris.php" class="btn btn-secondary">Batal</a>
        </form>
    </div>
