                    ...
                    <div class="collapse navbar-collapse " id="navbarNav">
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item">
                             ...
                             <li class="nav-item">
                                <a class="nav-link active mx-3" href="perpus.php">Ruang Baca</a>
                            </li>
                              <li class="nav-item">
    ...
    <div class="container-fluid p-1">
        <div class="container pt-5 pb-3">
            <div class="text-center mb-3 pb-3">
                                <h1 class="text-primary " style="letter-spacing: 5px;">Ruang Baca</h1>
                <h5 class="text-primary text-uppercase" style="letter-spacing: 5px;">Temukan Ruang Peningkat Produktif Kamu</h5>
                 <h6 class="text-success" >(hubungi Admin terlebih dahulu Pada WhatsApp yang tertera untuk melakukan reservasi ruangan)</h6>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="card text-light bg-white pb-2">
                        <div class="card-body text-dark">
                            <div class="img-area mb-4">
                                <img class="img-fluid" src="Asset/img/ruangtemu.jpg" alt="">
                            </div>
                            <h3 class="card-tittle">Ruang Temu</h3>
                            <p class="lead">Sebuah ruangan yang membantu kamu untuk bisa reservasi tempat guna melakukan sebuah meeting, bertemu dengan partner, teman kerja dan sebagainya yang membahas tentang cita cita di masa depan.
            
                            </p><br>
                               <p class="lead">Rincian Harga Sewa & Fasilitas: </p>
                                <p class="lead">- Harga Sewa: 50.000 / 4 Jam <br>
                                - Fasilitas: (5 Seats), Minuman Gratis, Wifi Gratis, Koneksi Listrik.</p>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card text-light bg-white pb-2">
                        <div class="card-body text-dark">
                            <div class="img-area mb-4">
                                <img class="img-fluid" src="Asset/img/ruangproduktif.jpeg" alt="">
                            </div>
                            <h3 class="card-tittle">Ruang Produktif</h3>
                            <p class="lead">Sebuah ruangan yang membantu kamu untuk bisa produktif menyelesaikan tugas-tugas kamu.
            
                            </p><br>
                               <p class="lead">Rincian Harga Sewa & Fasilitas: </p>
                                <p class="lead">- Harga Sewa: 20.000 / 4 Jam <br>
                                - Fasilitas: (1 Seats), Minuman Gratis, Wifi Gratis, Koneksi Listrik.</p>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card text-light bg-white pb-2">
                        <div class="card-body text-dark">
                            <div class="img-area mb-4">
                                <img class="img-fluid" src="Asset/img/ruangkolaborasi.jpg" alt="">
                            </div>
                            <h3 class="card-tittle">Ruang Kolaborasi</h3>
                             <p class="lead">Sebuah ruangan yang membantu kamu yang sedang butuh ruangan untuk mengadakan event, pertemuan, dan kegiatan-kegiatanmu.
            
                            </p><br>
                               <p class="lead">Rincian Harga Sewa & Fasilitas: </p>
                                <p class="lead">- Harga Sewa: 500.000 / 4 Jam <br>
                                - Fasilitas: (20 Seats), Minuman Gratis, Wifi Gratis, Koneksi Listrik.</p>
